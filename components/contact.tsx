      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          <div className="relative group">
            ...
            <button
              onClick={copyEmail}
              className="absolute top-4 right-4 p-2 bg-background/80 backdrop-blur-sm rounded-lg border border-border hover:border-primary transition-all hover:scale-110 opacity-0 group-hover:opacity-100"
